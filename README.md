...
3_top_demanding_skills.sqlLooks like the formatting got a bit mangled — the `---` section separators and some code blocks probably broke when you pasted. Let me give you a clean, copy-paste-ready version of just the README content that should go in without issues:
...
**Insight:** Reveals what qualifications separate the highest earners.
...
1. Clone this repo.
2. Run the SQL files against your job postings database in order.
3. Modify filters (e.g., location, job title) to explore other roles.
